...
int main (int argc,char *argv[])
{
  ...
  12:	8b 59 04             	mov    0x4(%ecx),%ebx
	...
	int  a, b;	
	pid = fork();
  15:	e8 a0 02 00 00       	call   2ba <fork>
	if (pid == 0)
  1a:	85 c0                	test   %eax,%eax
  1c:	75 43                	jne    61 <main+0x61>
	{	
		exec(argv[1], argv);
  1e:	52                   	push   %edx
  1f:	52                   	push   %edx
  ...
  24:	e8 d1 02 00 00       	call   2fa <exec>
		printf(1, "exec %s failed\n", argv[1]);
  29:	83 c4 0c             	add    $0xc,%esp
  2c:	ff 73 04             	pushl  0x4(%ebx)
  2f:	68 30 07 00 00       	push   $0x730
  34:	6a 01                	push   $0x1
  ...
  61:	50                   	push   %eax
  62:	50                   	push   %eax
  63:	8d 45 f4             	lea    -0xc(%ebp),%eax
  66:	50                   	push   %eax
  67:	8d 45 f0             	lea    -0x10(%ebp),%eax
  6a:	50                   	push   %eax
  6b:	e8 f2 02 00 00       	call   362 <waitx>
  70:	83 c4 10             	add    $0x10,%esp
  73:	a3 20 0a 00 00       	mov    %eax,0xa20
  78:	eb c4                	jmp    3e <main+0x3e>
  7a:	66 90                	xchg   %ax,%ax
  7c:	66 90                	xchg   %ax,%ax
  7e:	66 90                	xchg   %ax,%ax
...
00000410 <printf>:
 ...
 52b:	b8 70 07 00 00       	mov    $0x770,%eax
...
000005b0 <free>:
 5b0:	55                   	push   %ebp
 5b1:	a1 14 0a 00 00       	mov    0xa14,%eax
 ...
 62d:	a3 14 0a 00 00       	mov    %eax,0xa14
...
00000640 <malloc>:
 ...
 64c:	8b 15 14 0a 00 00    	mov    0xa14,%edx
 ...
 6a1:	39 05 14 0a 00 00    	cmp    %eax,0xa14
 ...
 6cb:	8b 15 14 0a 00 00    	mov    0xa14,%edx
 ...
 6ef:	89 15 14 0a 00 00    	mov    %edx,0xa14
 ...
 706:	c7 05 14 0a 00 00 18 	movl   $0xa18,0xa14
 70d:	0a 00 00 
 710:	c7 05 18 0a 00 00 18 	movl   $0xa18,0xa18
 717:	0a 00 00 
 71a:	b8 18 0a 00 00       	mov    $0xa18,%eax
 71f:	c7 05 1c 0a 00 00 00 	movl   $0x0,0xa1c
 726:	00 00 00 
